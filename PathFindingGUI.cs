    ...
    */ 
    public class PathFindingGUI:AbstractWindow, IHandleEvent
    {
        ...
        public override void DisplayGUI()
        {
            ...
            // Draw StartNode.
            SplashKit.FillRectangle(Color.Black, StartX * CellSize, StartY * CellSize, CellSize, CellSize);
            // Draw EndNode.
            SplashKit.FillRectangle(Color.Blue, EndX * CellSize, EndY * CellSize, CellSize, CellSize);
            // Draw Walls.
            for (int x = 0; x < _pathFinding.GetGrid().Column; x++)
            {
                for (int y = 0; y < _pathFinding.GetGrid().Row; y++)
                {
                    ...
                    if (!wall.IsWalkAble)
                    {
                        SplashKit.FillRectangle(Color.Red, wall.X * CellSize, wall.Y * CellSize, CellSize, CellSize);
                    }
